    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="店铺类别" prop="dianpuleibie">
          <el-select :disabled="ro.dianpuleibie" v-model="ruleForm.dianpuleibie" placeholder="请选择店铺类别">
            <el-option
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="店铺区域" prop="dianpuquyu">
          <el-input v-model="ruleForm.dianpuquyu" 
              placeholder="店铺区域" clearable  :readonly="ro.dianpuquyu"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="店铺区域" prop="dianpuquyu">
              <el-input v-model="ruleForm.dianpuquyu" 
                placeholder="店铺区域" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
      ...
      this.$http({
		...
		if(json.shangjiamingcheng!=''&&json.shangjiamingcheng){
          ...
          this.$message.error(data.msg);
            ...
            this.$http({
              url: `option/dianpuleibie/dianpuleibie`,
              method: "get"
            }).then(({ data }) => {
              if (data && data.code === 0) {
	...
	this.ruleForm.dianpujianjie = this.ruleForm.dianpujianjie.replace(reg,'../../../ssm3rc1k/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
